...
두 장의 손그림 메모를 바탕으로 작성한 기획·개발 문서, 게임 에셋, 그리고 이를 구현한 로컬 **2인 전용** 웹 게임(알파 버전)입니다. 게임명은 저장소 이름에서 가져온 **가칭**입니다.
...
npm test         # node --test, 이동·조준·발사·무기 선택·수류탄·총기 피해·체력·엄폐물·드론·전투기·통계·밸런스 로직 검증
```
...
**2인 전용**입니다. 경기 전 준비 화면에서 P1(지구방위팀)·P2(ISB팀)가 각각 **캐릭터 5명 중 하나와 주무기를 고릅니다.** 주무기는 경기 중에 바꿀 수 없습니다.
