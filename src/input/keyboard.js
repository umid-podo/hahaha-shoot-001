...
// aimLeft/aimRight는 조준선을 화면 왼쪽/오른쪽으로 돌린다. swap은 다음 무기로 교체.
export const KEYMAP = {
...
const FIRE_HINT = '누르고 있으면 연사(RPG는 떼면 발사)';
export const KEY_LABELS = {
  P1: `A/D 이동 · W/S 조준 · F ${FIRE_HINT} · E 무기 교체`,
  P2: `←/→ 이동 · ↑/↓ 조준 · Enter ${FIRE_HINT} · 오른쪽 Shift 무기 교체`,
  P3: `J/L 이동 · I/K 조준 · H ${FIRE_HINT} · U 무기 교체`,
  P4: `Num4/6 이동 · Num8/5 조준 · Num0 ${FIRE_HINT} · Num+ 무기 교체`,
};
