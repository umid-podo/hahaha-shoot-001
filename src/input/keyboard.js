...
// aimLeft/aimRight는 조준선을 화면 왼쪽/오른쪽으로 돌린다.
export const KEYMAP = {
  P1: { left: 'KeyA', right: 'KeyD', aimLeft: 'KeyW', aimRight: 'KeyS', fire: 'KeyF' },
  P2: { left: 'ArrowLeft', right: 'ArrowRight', aimLeft: 'ArrowUp', aimRight: 'ArrowDown', fire: 'Enter' },
  P3: { left: 'KeyJ', right: 'KeyL', aimLeft: 'KeyI', aimRight: 'KeyK', fire: 'KeyH' },
